...
import com.uranium.commands.EnhancedUraniumCommand;
...
public class UraniumCraft extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        MessageUtil.log("&a✓ Визуальные эффекты активированы");
        
        // Инициализация новых менеджеров
        craftingManager = new CraftingManager(this);
        MessageUtil.log("&a✓ Система крафтов активирована");
        
        // Регистрация команд
        getCommand("uranium").setExecutor(new EnhancedUraniumCommand(this));
    ...
    public void onDisable() {
        ...
        if (hologramManager != null) {
            ...
            MessageUtil.log("&7✓ Голограммы удалены");
        }
